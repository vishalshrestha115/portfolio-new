export const siteConfig = {
  name: "Vishal Shrestha | Developer Portfolio",
  authorName: "Vishal Shrestha",
  username: "namanbarkiya",
  description:
    "Vishal Shrestha's portfolio - A modern, responsive Next.js portfolio for developers. This open-source template can be customized to showcase your own skills, projects, and professional experience.",
